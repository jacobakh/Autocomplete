 ...
 *
 *     * Displays the result in a browser if the user selects a word
            ...
            if (text.equals("")) {
                ...
                if (!resultQ.isEmpty()) {
                    ...
                    for (int i = 0; i < results.length; i++) {
                        ...
                        /*Modified to include the weights of each word and a delimiter "|" to ensure that
